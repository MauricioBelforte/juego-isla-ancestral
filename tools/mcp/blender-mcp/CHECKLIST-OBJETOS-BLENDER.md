...
- [ ] Hongo luminoso (cuevas/templo subterráneo)
- [x] Hongo luminoso — `crear_hongo_luminoso_lowpoly.py` + cap 2026-08-28 15-09
- [ ] Flor de isla (ejemplar coleccionable)
...
- [ ] Árbol frutal (mango/coco según lore)
- [ ] Musgo en roca (placa decorativa)
- [ ] Raíces expuestas (para bordes de terreno)

## Módulo 15 — Recursos (materiales recolectables) ⛏️

- [x] Roca común (recolectable) — script + .blend + capturas ✅ 2026-08-28
- [ ] Roca de pedernal
- [x] Roca de pedernal — `crear_roca_pedernal_lowpoly.py` + cap 2026-08-28 15-10
- [x] Veta de cobre — `crear_veta_cobre_lowpoly.py` (v2, 10 obj.) + cap 2026-08-28 15-13 (roca + 6 prismas hexagonales cobre)
- [x] Veta de hierro — `crear_veta_hierro_lowpoly.py` + 6 capturas orbitales 18-52 (aprobado, roca gris + 5 cristales, z_min 0.018 ok)
- [x] Veta de oro — `crear_veta_oro_lowpoly.py` + 6 capturas orbitales 19-40 (aprobado, roca gris + 3 pepitas; z_min 0.045) 2026-08-28
...
- [ ] Pared de madera (módulo base)
- [ ] Pared con ventana
- [ ] Pared con puerta
- [ ] Piso de madera (módulo)
- [ ] Techo a dos aguas (módulo)
- [ ] Techo de paja (variante)
- [ ] Puerta articulada
- [ ] Ventana con marco
- [ ] Escalera de mano
- [ ] Zócalo/fundamento de piedra
- [ ] Casa completa ejemplo (composición, referencia visual)
...
- Total ítems: **117**
- Completados: **51** (47 previos + 4 de M70 en esta tanda, verificados visualmente 2026-08-29 23:15)
- Pendientes de captura: **0**
- Aprobados visualmente: 84 (80 previos + Botón/Puerta/Cofre/Válvula)
...
- Fecha de creación: 2026-08-27 · Última actualización: 2026-08-30 00:15
