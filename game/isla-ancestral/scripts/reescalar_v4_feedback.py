"""
M50 v4 (feedback usuario 2026-09-04 10:05):
  flor: x3 más grande (0.8m -> 2.4m)
  hierba_alta: más baja (0.4m -> 0.15m)
  liana: más grande (2m -> 4m)
  helecho_gigante: más pequeño (1.5m -> 0.8m)
  helecho_chico: más pequeño (0.6m -> 0.35m)
Escalado relativo desde la altura ACTUAL de cada GLB (ya horneados antes).
"""
import bpy
import os
...
AJUSTES = {
    "50-Vegetacion_flor_isla": 2.4,
    "50-Vegetacion_hierba_alta": 0.15,
    "50-Vegetacion_liana_colgante": 4.0,
    "50-Vegetacion_helecho_gigante": 0.8,
    "50-Vegetacion_helecho_chico": 0.35,
}
