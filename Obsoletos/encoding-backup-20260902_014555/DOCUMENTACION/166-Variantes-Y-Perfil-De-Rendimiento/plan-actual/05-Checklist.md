...
- [x] A15. Documentar el diagrama de 2 ejes (detalle â†‘ vs draw calls â†’) en `02-Analisis.md`.

## B. Tabla de presupuestos (16–25)

- [x] B1. ALTA: â‰¤ 16 objetos (tras merge) / â‰¤ 6.000 tris / â‰¤ 12 materiales.
- [x] B2. MEDIA: â‰¤ 8 objetos / â‰¤ 1.500 tris / â‰¤ 8 materiales.
- [x] B3. BAJA: â‰¤ 6 objetos / â‰¤ 700 tris / â‰¤ 4 materiales.
...
- [x] D13. Solo `SM_*` y `MAT_*` cruzan la frontera Blender â†’ Godot.
...
- [x] H3. Criterio 2: si se sostiene en mano y se ve en primer plano â†’ ALTA.
- [x] H4. Criterio 3: si es un hito visual de la isla â†’ ALTA.
- [x] H5. Criterio 4: si se instancia por cientos (MultiMesh) â†’ solo MEDIA.
