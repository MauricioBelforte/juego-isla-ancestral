...
```
[OS] â”€â”€â–º OS.get_name(), OS.get_version()
[CPU] â”€â”€â–º OS.get_processor_count(), OS.get_processor_name()
[GPU] â”€â”€â–º RenderingServer.get_rendering_info()
[RAM] â”€â”€â–º OS.get_memory_info()
[VRAM] â”€â”€â–º RenderingServer.get_rendering_info()
```
...
|------------|--------|-------|
| Windows 10/11 | âœ… Principal | Primary target |
| Linux | âœ… Soportado | Proton/SteamOS compatibility |
| macOS | âš ï¸ Limitado | Metal support, sin optimización nativa |
| Steam Deck | ✅ Soportado | Optimización específica |
| PlayStation | âŒ No soportado | v2+ |
| Xbox | âŒ No soportado | v2+ |
| Nintendo Switch | âŒ No soportado | v2+ |
| Mobile | âŒ No soportado | v2+ |

### Dispositivos de Entrada

| Dispositivo | Soporte | Notas |
|-------------|---------|-------|
| Teclado + Mouse | âœ… Principal | Primary PC input |
| Xbox Controller | âœ… Soportado | XInput nativo |
| PlayStation Controller | âœ… Soportado | DualShock/DualSense |
| Switch Pro Controller | âœ… Soportado | DirectInput |
| Touch Screen | âŒ No soportado | v2+ |
| VR | âŒ No soportado | Nunca |
