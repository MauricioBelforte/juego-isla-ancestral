...
[HardwareDetector]
       â”‚
       â”œâ”€â”€â–º Detectar CPU (cores, freq)
       â”œâ”€â”€â–º Detectar GPU (nombre, VRAM)
       â”œâ”€â”€â–º Detectar RAM total
       â”œâ”€â”€â–º Detectar OS
       â””â”€â”€â–º Detectar Input Devices
              â”‚
              â–¼
       [HardwareProfile]
              â”‚
       ...
       [QualityPresetSelector]
              â”‚
              â”œâ”€â”€ ProfileåŠ£åŠ£ â”€â”€â–º Very Low
              â”œâ”€â”€ Profile Low â”€â”€â–º Low
              â”œâ”€â”€ Profile Medium â”€â”€â–º Medium
              â”œâ”€â”€ Profile High â”€â”€â–º High
              â””â”€â”€ Profile Ultra â”€â”€â–º Ultra
                     â”‚
                     â–¼
...
```
[M90 Settings UI] â”€â”€â–º [HardwareDetector.detect()]
                            â”‚
                            â–¼
                       [QualityPresetSelector]
                            â”‚
...
```
[M61 Performance Monitor] â”€â”€â–º [Auto-adjust quality if needed]
                                    â”‚
                                    â–¼
                               [QualityApplier.apply_preset()]
```
...
```
[M57 Input Manager] â”€â”€â–º [Detect gamepad type]
                              â”‚
                              â–¼
...
```
user://hardware_profile.tres     â† Perfil detectado
user://quality_settings.tres     â† Configuración de calidad
user://input_mapping.tres        â† Mapeo de dispositivos
```
