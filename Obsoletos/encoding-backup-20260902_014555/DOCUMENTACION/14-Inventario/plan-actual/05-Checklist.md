...
- [x] ItemCatalog: registro central id â†’ ItemData con carga bajo demanda (M159 `item_database.gd`) [M]
...
- [x] Resultado de craft: bolsillo â†’ casa â†’ mundo en cadena [C]
...
- [x] Apertura del inventario â‰¤ 5 ms [M]
...
- **E5 Favoritos:** Tecla F toggle favorito en slot hover, indicador â˜… en slots
...
- **Fav label:** Label â˜… visible en slots con favorito
...
- Para drag-drop entre contenedores (bolsilloâ†”casa), extender _finish_drag para acceptar to_container
