...
var casa: Inventory
var cofres: Dictionary[String, Inventory]                # id_cofre â†’ contenedor
...
### H1 — Colisión de `class_name ItemData` âš ï¸ CRÍTICO
...
### H2 — Nombre del autoload fijado por M39 âš ï¸ CRÍTICO
...
2. `scripts/inventario/inventario_service.gd` â†’ autoload **Inventario** con API rica + adaptadores M39
3. `scripts/inventario/inventario_save.gd` â†’ ISaveProvider registrado en SaveManager
