...
- [ ] RF2: parcelas con límite de cultivos activos (M17) [S]
...
- [ ] RF7 a RF12: estaciones, cosecha, comida opcional, cultivos especiales, fertilizante y persistencia [S]
...
- [ ] P4: crecimiento — avance por días acumulados [S]
...
- [ ] P8: cosecha — event crop_harvested y entrega a M14 [S]
- [ ] P9: herramientas — pala y regadera integradas vía ToolService (M13) [S]
- [ ] P10: estaciones — ventana por cultivo; fuera de ventana DORMANTE [S]
- [ ] P11: cultivos especiales — trigo invernal, higos, ancestrales de desbloqueo M22 [M]
- [ ] P12: árboles frutales — perennes con cooldown frutal, sin replantar [M]
...
- [ ] P19: recuperación — siempre por riego o cambio de estación; cero pérdida de progreso [S]
- [ ] P20: almacenamiento — la cosecha entra directa a M14, sin inventario de plantas [S]
...
- [ ] Definir water_need (1 o 2) por cultivo [S]
...
- [ ] Crear CropTile extends RefCounted (estado puro por voxel) [S]
- [ ] Campos: voxel_pos, crop_def, stage, grown_days, water_level, fertilized, quality, planted_at_day [S]
- [ ] Implementar is_ready(), is_paused(), current_stage_index() [S]
- [ ] Implementar can_advance_today(season, rain) con reglas de estación y agua [S]
- [ ] Implementar apply_daily_tick(season, rain) sin retroceder etapas [S]
- [ ] Estado SEMILLA inicial con water 0 [S]
- [ ] Estados DORMANTE y SIN_AGUA sin consumo de días [S]
...
- [ ] Diccionario _tiles Vector3i→CropTile [S]
