...
- [x] Crear tests unitarios (M112)
- [x] Crear tests de integración (M112)
...
- [x] Definir convenciones de grupos de nodos
- [x] Definir convenciones de layers de física/render
...
- [x] Diseñar patrón State Machine
- [x] Diseñar patrón Observer (EventBus)
- [x] Diseñar patrón Service Locator
- [x] Diseñar patrón Factory
- [x] Diseñar patrón Command
- [x] Diseñar patrón Strategy
- [x] Especificar uso de composición sobre herencia profunda
- [x] Especificar máximo 3 niveles de herencia
- [x] Diseñar componentes reutilizables (HealthComponent, InventoryComponent, StateComponent)

### [S] Utilidades comunes
- [x] Diseñar MathUtils con distance_squared()
- [x] Diseñar MathUtils con lerp()
- [x] Diseñar MathUtils con clamp()
- [x] Diseñar MathUtils con normalize_angle()
- [x] Diseñar ValidationUtils con is_valid_position()
- [x] Diseñar ValidationUtils con is_valid_item_id()
- [x] Diseñar ValidationUtils con is_valid_npc_id()
- [x] Diseñar ValidationUtils con is_valid_mission_id()
- [x] Diseñar FormatUtils con format_time()
- [x] Diseñar FormatUtils con format_money()

### [S] Constantes del proyecto
- [x] Diseñar GameConstants con MAX_INVENTORY_SIZE
- [x] Diseñar GameConstants con DAY_DURATION_SECONDS
- [x] Diseñar GameConstants con CHUNK_SIZE
- [x] Diseñar GameConstants con MAX_PLAYERS
- [x] Diseñar GameConstants con MAX_SAVE_SLOTS
- [x] Diseñar GameConstants con AUTO_SAVE_INTERVAL_SECONDS

### [S] Enums del proyecto
- [x] Diseñar GameEnums con State (IDLE, WALKING, RUNNING, etc.)
- [x] Diseñar GameEnums con Category (GAMEPLAY, UI, AUDIO, SYSTEM)
- [x] Diseñar GameEnums con Priority (LOW, MEDIUM, HIGH, IMMEDIATE)

### [S] Estructuras de datos
- [x] Diseñar struct PlayerData
- [x] Diseñar struct ItemData
- [x] Diseñar struct NPCData
- [x] Diseñar struct MissionData
