...
| Guardado y serialización | ✅ Implementado (M59: cola atómica + backup rotativo + dirty tracking + auto-save + providers por duck-typing — Log 368) | 59 Guardado |
...
| Viajes y mundo abierto | 🟡 TravelService núcleo (rutas JSON, clima retraso-sin-bloqueo, persistencia mitad de ruta — Log 371); escénico V2 | 28 Viajes |
| Colecciones y museo | 🟡 CollectionRegistry + DonationService núcleo (donaciones validadas, recompensas únicas — Log 372); escénico V2 | 37 Museos |
| Onboarding | 🟡 TutorialManager con triggers de acción/mundo/watchdog (Log 320); presentación V2 | 92 Tutorial |
| Localización | 🟡 es/en vía .po + tr_key/tr_ctx + persistencia de locale (sección "general" M60 — Log 373) | 87 Localización |
