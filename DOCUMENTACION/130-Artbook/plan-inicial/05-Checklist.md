...
- [ ] Documentar el pipeline de curaduría en el capítulo 12 [S]
...
- [ ] Seleccionar paletas pastel exploratorias (RF1) [M]
- [ ] Seleccionar pruebas de estilo voxel tempranas [M]
- [ ] Seleccionar moodboards fundacionales [M]
- [ ] Documentar la definición del estilo Cozy Voxel del proyecto [M]
...
- [ ] Documentar cambios de paleta por hito [M]
- [ ] Documentar cambios de escala de voxel/personaje [S]
...
- [ ] Documentar decisiones de layout jugable (distancias, rutas) [M]
...
- [ ] Documentar decisiones de silueta y legibilidad a distancia [M]
...
- [ ] Documentar decisiones de comportamiento visual (manadas, bancos) [M]
...
- [ ] Documentar la gramática visual de las ruinas (reglas de construcción) [M]
...
- [ ] Documentar decisiones de "sin estadísticas de daño" en el diseño visual [S]
...
- [ ] Incluir paletas por bioma [M]
- [ ] Incluir transiciones entre biomas [M]
- [ ] Documentar decisiones de clima visual por región [M]
...
- [ ] Documentar la selección de fuentes Nunito/Fredoka (M88) [S]
...
- [ ] Documentar el pipeline de arte de punta a punta [M]
- [ ] Documentar el validador de assets [S]
...
- [ ] Incluir avisos de copyright del libro (M127) [S]
- [ ] Definir página legal del libro (edición, ISBN opcional) [M]
- [ ] Verificar que ningún extracto de marketing filtre spoilers (M99) [M]
- [ ] Definir política de uso de imágenes del artbook por creadores de contenido [S]

## Q. Integración y Cierre

- [ ] Coordinar SKU y precio con M129 (USD 30-50) [S]
- [ ] Coordinar tirada limitada numerada con M129 [S]
- [ ] Coordinar cubierta con manual de marca M128 [M]
- [ ] Preparar extractos sin spoilers para M99 [M]
- [ ] Definir criterio de volumen 2 post-DLC (M120) [S]
- [ ] Congelar manifiesto en cierre editorial post-RC (M142) [S]
- [ ] Ejecutar validador del manifiesto sin errores [S]
