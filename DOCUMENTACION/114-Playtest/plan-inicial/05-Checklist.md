...
- [ ] Definir el objetivo primario del módulo: medir y mejorar la experiencia real de jugadores con sesiones de playtest [S]
- [ ] Establecer que el playtest complementa (no reemplaza) al QA técnico (M101) [S]
...
- [ ] Definir el ciclo de ronda de playtest con 6 etapas: planificar, reclutar, ejecutar, analizar, priorizar, iterar [M]
...
- [ ] Redactar convocatoria de tester con criterios de exclusión (sin spoilers del roadmap, sin desarrollo de juegos) [M]
...
- [ ] Documentar el derecho del tester a retirarse y solicitar borrado de datos [S]
...
- [ ] Definir preparación de la build de testeo: guardados limpios pre-generados [M]
- [ ] Definir registro de la build testeada (hash/commit) en cada sesión [S]
...
- [ ] Definir la técnica think-aloud y su instrucción al tester [S]
...
- [ ] Definir manejo del tester bloqueado: registrar el evento y ayudar solo al final [S]
...
- [ ] Definir instrucciones escritas estándar para el tester libre [S]
...
- [ ] Medir si el tester sigue jugando al terminar el tiempo (indicador de disfrute) [M]
...
- [ ] Establecer que el observador anota al menos 1 cita textual del tester [S]
...
- [ ] Definir umbral de respuesta: mínimo 80% de testers completan la encuesta [S]
...
- [ ] Definir flujo de regresión social: retest del fix con jugadores nuevos en la ronda siguiente [M]
...
- [ ] Definir nomenclatura de archivo de sesión: AAAA-MM-DD_{ronda}_{aliasTester} [S]
...
- [ ] Establecer retención de datos mínima necesaria y borrado a solicitud del tester [M]
- [ ] Definir que las ideas de contenido futuro de los testers se registran en 5-FUTURAS-MEJORAS vía el usuario [S]

## 11. Requisitos No Funcionales

- [ ] Documentar RN1: confidencialidad de datos de testers según M80 [S]
...
- [ ] Analizar los tipos de playtest aplicables al proyecto (prototipo, usabilidad, tono, pacing, guiado, libre, regresión social, accesibilidad) [M]
- [ ] Determinar cuándo corresponde cada tipo según la etapa del proyecto [M]
- [ ] Justificar la frecuencia de playtest por etapa (prototipo 1 ronda, pre-alpha por hito) [M]
- [ ] Fundamentar el tamaño de muestra con la regla de Nielsen (5 testers detectan ~85% de problemas) [M]
...
- [ ] Evaluar alternativas descartadas (solo QA, playtest público, solo encuesta, solo guiado) con justificación [M]
...
- [ ] Documentar integración con M137 (Prototipo): builds estables que llegan al playtest [M]
...
- [ ] Documentar integración con M110 (Debug Menu): acceso opcional en builds de testeo [S]
...
- [ ] Definir manejo de tester demasiado familiarizado con el juego (sesgo de conocimiento previo) [M]
- [ ] Definir manejo de tester que es amigo/familiar del equipo (feedback sesgado por complacencia) [M]
- [ ] Definir manejo de pocos testers: mínimo 3; si no se alcanza, documentar la limitación de la ronda [M]
- [ ] Definir manejo de feedback contradictorio entre testers: resolver con evidencia observacional y prioridad de tono [M]
- [ ] Definir manejo de hallazgos repetidos: la saturación confirma el problema sin más jugadores [S]
- [ ] Definir manejo de tester que abandona a mitad de sesión: registrar causa y continuar con el resto [S]
- [ ] Definir manejo de crash/glitch en sesión: código ERR, reinicio de sesión y derivación a M102 [S]
- [ ] Definir manejo de tester que busca agradar al moderador (demand characteristics) [M]
...
- [ ] Definir manejo de datos de tester que solicita borrado: eliminación en 48 horas y notificación [M]
...
- [ ] Definir prueba de NDA y consentimiento con un tester de prueba (flujo de firma) [S]
