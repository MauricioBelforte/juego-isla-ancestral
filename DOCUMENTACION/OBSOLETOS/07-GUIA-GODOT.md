**Modelo:** glm-5.3-flash (Kilo Code) (último modificador 2026-09-09: §13.7-13.10 anti-tildes + receta disco sólido + E-16 a E-19; 2026-09-07: E-16 BOM .tres; 2026-09-06: E-13/E-14/E-15 — ZIPPacker sin finish_file, ternario C-like inválido, Godot stub bloqueado. Historial: glm-5.3-free 2026-09-05 §12 animales bimodo, E-11/E-12; glm-5.3 (Cline) 2026-09-04 §9.64 C56; GLM 5.3 (z-ai) 2026-09-02: §11 flujo Blender→Godot, caso tortuga M36; glm-5.3-flash 2026-09-01 §9.56-9.60; deepseek-v4-flash §9.54/§9.55; glm-5.3 §9.53; MiMo V2.5 creó la guía; múltiples agentes §9.x)
**Plataforma:** Kilo Code

# 07-GUIA-GODOT.md — Guía de Codificación en Godot 4.x

> 📖 **MIGRACIÓN A CARPETA TEMÁTICA**: la documentación detallada de los temas de esta guía se está migrando a **`DOCUMENTACION/GUIA-GODOT/`** — archivos temáticos individuales con recetas completas probadas y errores documentados. Índice: [`GUIA-GODOT/INDICE.md`](GUIA-GODOT/INDICE.md). Actualmente: zoom de cámara, disco plano sólido, impostores del terreno. Esta guía queda como respaldo/índice general.
>
