...
- [x] Registrar obras relevantes cuando corresponda
- [x] Registrar código
- [x] Registrar arte
- [x] Registrar música
- [x] Registrar narrativa
- [x] Registrar logos
- [x] Mantener evidencia de autoría

### [S] Copyright automatico
- [x] Definir copyright automatico en creacion (Berne Convention)
- [x] Definir código (automatico en creacion)
- [x] Definir arte (automatico en creacion)
- [x] Definir música (automatico en creacion)
- [x] Definir narrativa (automatico en creacion)
...
- [x] Diseñar beneficios (proteccion legal, presuncion de validez)

### [S] Evidencia de autoría
- [x] Definir git logs (commits, autores, fechas)
- [x] Definir timestamps (archivos, commits)
- [x] Definir borradores (sketches, iteraciones)
- [x] Definir metadata (EXIF, IPTC, tags)

### [S] Código
- [x] Definir registro de código (copyright automatico)
- [x] Definir evidencia de autoría (git logs, timestamps)
- [x] Diseñar git logs como prueba de evolucion
- [x] Diseñar git blame para rastrear autoría

### [S] Arte
- [x] Definir registro de arte (copyright automatico)
- [x] Definir evidencia de autoría (timestamps, borradores)
- [x] Diseñar timestamps de archivos como evidencia
- [x] Diseñar borradores de arte (sketches, iteraciones)

### [S] Música
- [x] Definir registro de música (copyright automatico)
- [x] Definir evidencia de autoría (timestamps, archivos de proyecto)
- [x] Diseñar timestamps de archivos como evidencia
- [x] Diseñar archivos de proyecto (DAW, MIDI)

### [S] Narrativa
- [x] Definir registro de narrativa (copyright automatico)
- [x] Definir evidencia de autoría (timestamps, borradores)
- [x] Diseñar timestamps de archivos como evidencia
- [x] Diseñar borradores de narrativa (Google Docs, Word)
...
- [x] Diseñar prueba de que git logs muestren autoría correcta
- [x] Diseñar prueba de que timestamps sean consistentes
- [x] Diseñar prueba de que borradores estén accesibles
- [x] Diseñar prueba de que metadata esté presente
...
- [x] Diseñar sistema de resguardo inmutable de logs de Git y commits para trazabilidad de autoría en litigios [M]
...
- [x] Integrar con M41 (Música) para archivar sesiones multipista (DAW), stems y partituras como prueba de autoría [M]
- [x] Integrar con M45 (Arte 3D) para archivar archivos maestros .blend con timestamps de creación inmutables [M]
- [x] Integrar con M22 (Historia Principal) y M147 (World Building) para archivar borradores y cronología de lore [M]
- [x] Integrar con M131 (Créditos) para asegurar correspondencia 100% fiel entre autores reales y créditos in-game [S]
- [x] Integrar con M103 (Logging) para auditar cambios en declaraciones de derechos de autor y licencias [S]
- [x] Integrar con M107 (Backups) para resguardo redundante (estrategia 3-2-1) de evidencias de autoría original [M]

### Edge cases
- [x] Diseñar protocolo formal de respuesta y contra-notificación ante reclamos falsos o maliciosos de DMCA [M]
- [x] Establecer mecanismo de resolución de disputas de coautoría con colaboradores externos o exempleados [M]
- [x] Definir protocolo de evaluación legal ante inclusión de librerías open source con licencias copyleft o ambiguas [M]
- [x] Establecer plan de acción ante detección de clones, ripeos de assets o plagios en tiendas no autorizadas [M]
- [x] Diseñar procedimiento ante disputas de autoría de samples o librerías de sonido utilizadas en la música [M]
- [x] Definir gestión de propiedad intelectual sobre prototipos o conceptos desarrollados en game jams previas [S]
...
### Optimización
- [x] Automatizar el empaquetado de código y muestras visuales según los formatos y límites de tamaño de la USCO [M]
- [x] Desarrollar herramienta de escaneo de repositorio para detectar código huérfano sin atribución de autor [M]
- [x] Optimizar costos de registro formal agrupando múltiples obras relacionadas bajo registros colectivos [S]
- [x] Diseñar pipeline de metadata que no incremente innecesariamente el tamaño de los paquetes de distribución [S]
...
- [x] Mantener matriz de titularidad de derechos actualizada ante eventuales cesiones, acuerdos o publishing [S]

### Documentación
- [x] Redactar guía interna sobre buenas prácticas de preservación de evidencia de autoría para desarrolladores [M]
...
- [x] Diseñar contratos estándar de cesión de derechos de autor (Work for Hire) para freelancers y contratistas [M]
- [x] Documentar fechas clave de primera fijación y publicación de cada componente creativo de Isla Ancestral [S]
- [x] Elaborar FAQ interno sobre uso de referencias visuales, homenajes y límites del Fair Use [S]
...
- [x] Estandarizar el diseño visual de los certificados y carpetas del archivo histórico de propiedad intelectual [S]
- [x] Crear pantalla accesible y navegable de licencias de software y librerías de terceros en el menú de opciones [S]
- [x] Redactar acuerdos de cesión de derechos con tono amigable y explicaciones claras para artistas colaboradores [S]
