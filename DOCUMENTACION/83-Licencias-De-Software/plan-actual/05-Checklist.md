...
- [x] Cleanup automático de notices obsoletos al regenerar — agnes-2026-09-06: implementado en license_validator.gd cleanup_notices_obsoletas()
...
- [?] — agnes-2026-09-06: acción externa no ejecutable por agente (requiere contacto humano con abogado); pendiente acción del usuario Contacto de asesoría legal para casos edge
