...
- [x] Registrar dependencias: M04, M07, M11, M29, M31, M14, M19, M24, M08, M103 [S]
- [x] Catalogar los 20 puntos del plan maestro (sección 109) [S]
- [x] Definir criterios de aceptación verificables [S]
- [x] RF1: teletransporte del jugador [S]
- [x] RF2: cambio de hora (M29) [S]
- [x] RF3: cambio de estación (M29) [S]
- [x] RF4: cambio de clima (M31) [S]
- [x] RF5: dar objetos al inventario (M14) [S]
- [x] RF6: dar dinero (M38) [S]
- [x] RF7: completar misión (M22) [S]
- [x] RF8: desbloquear herramienta (M13) [S]
- [x] RF9: desbloquear isla (M28) [S]
- [x] RF10: desbloquear Sello (M22) [S]
- [x] RF11: resetear NPC (M19) [S]
- [x] RF12: resetear puzzle (M24) [S]
- [x] RF13: regenerar chunk (M08) [S]
- [x] RF14: mostrar colliders [S]
- [x] RF15: mostrar FPS [S]
- [x] RF16: mostrar chunks [S]
- [x] RF17: mostrar navegación [S]
- [x] RF18: mostrar hitboxes [S]
- [x] RF19: mostrar estados de IA [S]
...
- [x] Definir TitleBar con botón de cierre [S]
- [x] Documentar layout de cada panel [M]

## C. Panel Jugador (12)

- [x] Sección Teletransporte: inputs X/Y/Z [S]
- [x] Sección Teletransporte: botón "Ir" [S]
- [x] Sección Teletransporte: POI predefinidos (dropdown) [S]
- [x] Definir lista de POI (pueblo, templos, ruinas, islas) [M]
- [x] Sección Inventario: selector de item [S]
- [x] Sección Inventario: input de cantidad [S]
- [x] Sección Inventario: botón "Dar" [S]
- [x] Sección Inventario: input de dinero [S]
- [x] Sección Inventario: botón "Dar dinero" [S]
- [x] Sección Progresión: selector de misión [S]
- [x] Sección Progresión: botón "Completar" [S]
- [x] Sección Progresión: selector de herramienta [S]
- [x] Sección Progresión: botón "Desbloquear herramienta" [S]
- [x] Sección Progresión: selector de isla [S]
- [x] Sección Progresión: botón "Desbloquear isla" [S]
- [x] Sección Progresión: selector de Sello [S]
- [x] Sección Progresión: botón "Desbloquear Sello" [S]

## D. Panel Mundo (10)

- [x] Sección Tiempo: slider de hora (0-23) [S]
- [x] Sección Tiempo: label de hora actual [S]
- [x] Sección Tiempo: dropdown de estación [S]
- [x] Sección Clima: dropdown de clima [S]
- [x] Sección Generación: input de seed [S]
- [x] Sección Generación: botón "Aplicar seed" [S]
- [x] Sección Chunks: input de chunk X [S]
- [x] Sección Chunks: input de chunk Z [S]
- [x] Sección Chunks: botón "Regenerar" [S]
- [x] Integración con M29 (GameClock) [S]
- [x] Integración con M31 (WeatherSystem) [S]
- [x] Integración con M08 (WorldVoxel) [S]

## E. Panel Entidades (8)

- [x] Sección NPC: selector de NPC [S]
- [x] Sección NPC: botón "Resetear" [S]
- [x] Sección NPC: label de estado IA actual [S]
- [x] Sección Puzzles: selector de puzzle [S]
- [x] Sección Puzzles: botón "Resetear" [S]
- [x] Integración con M19 (NPCManager) [S]
- [x] Integración con M24 (PuzzleSystem) [S]
- [x] Integración con M64 (IA de NPC) [S]

## F. Panel Visualización (10)

- [x] CheckBox: "Mostrar Colliders" [S]
- [x] CheckBox: "Mostrar FPS" [S]
- [x] CheckBox: "Mostrar Chunks" [S]
- [x] CheckBox: "Mostrar Navegación" [S]
- [x] CheckBox: "Mostrar Hitboxes" [S]
- [x] CheckBox: "Mostrar Estados IA" [S]
- [x] Definir colores de visualización (verde, rojo, amarillo, azul) [S]
- [x] Definir límites de cantidad visualizada [S]
...
- [x] Sección Consola: límite de 100 líneas [S]
- [x] Sección Diagnóstico: botón "Exportar Diagnóstico" [S]
- [x] Sección Diagnóstico: botón "Reportar Bug" [S]
- [x] Sección Configuración: botón "Guardar Configuración" [S]
- [x] Integración con M103 (Logger) para consola [S]
- [x] Integración con M102 (Bug Tracking) para reportar bug [S]
- [x] Integración con DiagnosticExporter [S]
...
- [x] Suscribirse a señales de Logger [S]
- [x] Actualizar en tiempo real [S]
- [x] Limitar a 100 líneas (rotativo) [S]
...
- [x] Definir colores por tipo (collider estático/dinámico) [S]
- [x] Definir límites de chunks (radio 5 chunks) [S]
- [x] Definir límites de navigation (radio 50m) [S]
- [x] Definir límites de AI states (radio 50m) [S]
...
- [x] Capturar versión del juego [S]
- [x] Capturar plataforma y specs [S]
- [x] Capturar seed de generación [S]
- [x] Capturar posición del jugador [S]
- [x] Capturar FPS y memoria [S]
- [x] Capturar hora, estación, clima [S]
- [x] Exportar logs (últimas 1000 líneas) [S]
- [x] Capturar screenshot [S]
- [x] Crear archivo ZIP con metadata, logs, screenshot [S]
- [x] Generar URL de GitHub con plantilla pre-llenada [S]
- [x] Abrir navegador con URL [S]
...
- [x] Input actions desactivadas en release [S]
- [x] Configurar autoload solo en debug [S]
- [x] Verificación en runtime [S]
...
- [x] Guardar posición y tamaño de ventana [S]
...
- [x] Definir overhead máximo (<5% con visualizaciones) [S]
- [x] Actualizar FPS overlay cada 0.5s (no cada frame) [S]
- [x] Limitar consola a 100 líneas [S]
- [x] Limitar chunks visualizados (radio 5 chunks) [S]
- [x] Limitar navigation paths (radio 50m) [S]
- [x] Limitar AI states (radio 50m) [S]
- [x] Visualizaciones solo cuando Debug Menu visible [S]
- [x] Documentar budget de rendimiento [S]
...
- [x] Verificar que servicios estén disponibles antes de usar [S]
- [x] Manejar caso donde servicio no está disponible [S]
- [x] Documentar dependencias de servicios [S]
- [x] Usar ServiceLocator.get() para obtener servicios [S]
...
- [x] Definir estructura de user://diagnostics/ [S]
...
- [x] Los 20 puntos de la sección 109 resueltos [M]
