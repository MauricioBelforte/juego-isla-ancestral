## Etapa 1/5 — Casa 1: Choza Ampliada

Empezamos por la **choza de 5 × 4 m**, completa por fuera y amueblada por dentro. La usaremos como referencia de escala y acabado para las otras cuatro casas.

La propuesta mantiene el carácter **tropical ancestral**: tablones con variación cálida, postes oscuros, cimiento irregular, paja en capas y muebles de madera suavizados. **No utilizaremos cubos como estética final**, aunque algunas piezas estructurales partan de prismas.

**Desde aquí puedo entregarte el generador, pero no ejecutar Blender ni adjuntar modelos ya comprobados.** Este script produce los archivos al ejecutarse y registra los resultados reales.

### Decisiones para resolver la especificación

- **Coordenadas:** casa entre `X=0…5` y `Y=0…4`; frente en `Y=4`, mirando hacia `+Y`.
- **Cumbrera:** centrada en `X=2.50` y paralela al eje Y, como indicas.
- **Alturas interiores:** se miden desde el piso terminado, no desde el terreno.
- **Piso terminado:** `Z=0.245`; cimiento desde `Z=0.045`.
- **Cubierta:** arranca a 2,60 m sobre el piso y alcanza 3,20 m en su cara inferior central. Su espesor añade 0,12 m al exterior.
- **Huella de paredes:** 5 × 4 m. **Con aleros:** 5,60 × 4,60 m.
- **Puerta:** hueco libre real de 1 × 2,10 m; sin hoja por ahora.
- **Objetos:** 14 meshes de tu lista, más un Empty raíz.
- **Materiales:** ocho. Añadimos cortina translúcida y metal; no creamos `MAT_Cuero`, porque esta casa no tiene una pieza que lo necesite.
- **Circulación:** se reserva un pasillo central de 0,90 m. La separación silla–mesa se trata como conjunto funcional, no como pasillo de circulación.

**Los porcentajes de Decimate no garantizan los presupuestos.** El script reduce por conteo real hasta alcanzar MEDIA ≤1.500 y BAJA ≤700, o registra un error.

---

# Cómo ejecutarlo

Recomendado: **Blender 4.2 LTS o posterior**.
...
Ejecuta en una instancia dedicada:

```bash
blender --background --factory-startup --python crear_casa_01_choza.py
```

> **Atención:** limpia los objetos de la sesión actual. No lo ejecutes sobre trabajo sin guardar.
...
└── CASA_01_CHOZA/
    ├── ALTA/
    │   ├── SM_CASA_01_CHOZA_ALTA.blend
    │   └── SM_CASA_01_CHOZA_ALTA.glb
    ├── MEDIA/
    │   ├── SM_CASA_01_CHOZA_MEDIA.blend
    │   └── SM_CASA_01_CHOZA_MEDIA.glb
    ├── BAJA/
    │   ├── SM_CASA_01_CHOZA_BAJA.blend
    │   └── SM_CASA_01_CHOZA_BAJA.glb
    ├── CAPTURAS/
    │   ├── CASA01_EXTERIOR_..._000.jpg
    │   ├── ...
    │   ├── CASA01_EXTERIOR_..._300.jpg
    │   └── CASA01_INTERIOR_INSPECCION_...jpg
    └── INFORME_CASA_01.json
```

Las imágenes de inspección ocultan temporalmente la cubierta y la pared frontal. **Los archivos finales conservan la casa completa.**

## Distribución interior

Vista en planta; frente arriba:
...
```text
             ...
             │       Acceso libre        │
 Ventana     │                           │     Ventana
 lateral     │  CAMA       SILLA   MESA   │     lateral
             │  CAMA                     │
             │  CAMA              EST.   │
             │              HOGAR        │
             └───────────────────────────┘
...
- Cama contra el lateral izquierdo.
- Mesa contra el lateral derecho.
- Silla orientada hacia la mesa.
- Estantería lateral, hacia el fondo.
- Hogar al fondo, con chimenea atravesando un **hueco real de la cubierta**.
- Acceso central sin mobiliario.

## Consideraciones para Godot

- La casa entra como composición jerárquica bajo `SM_CASA_01_CHOZA`.
- La altura de apoyo pasa de **Z=0.045 en Blender a Y=0.045 en Godot**.
- El piso interior queda a **Y=0.245**. Hay un desnivel de entrada que deberá resolverse con un escalón, terreno elevado o una pequeña rampa de colisión.
- Las propiedades `INTERACTIVO` son metadatos del `.blend`; **este script no crea todavía interacción ni colisiones en Godot**.
- No uses una única caja de colisión para la casa: bloquearía la puerta y el interior.
- Los LOD reducidos están pensados para distancia. **Cuando el jugador entre, debe mantenerse ALTA**, porque Decimate puede deteriorar marcos, patas de muebles y abertura de chimenea.

---

## Próxima etapa: Casa 2 — Casa Mediana

Seguimos después con la casa de **8 × 6 m**, incorporando:

- Dos ambientes y paso interior.
- Cocina, mesa con cuatro sillas y dormitorio doble.
- Cuatro ventanas.
- Claraboyas y macetas.
- Materiales consolidados para respetar ocho en ALTA.

En esa casa resolveremos explícitamente dos conflictos del listado: **11 materiales solicitados frente al límite de ocho**, y más muebles que los 18 meshes enumerados. Los muebles seguirán presentes; se agruparán por conjuntos sin convertirlos en módulos de construcción.