...
- [ ] Definir RF5: minimapa simple ocultable con POIs [S]
...
- [ ] Crear ResourceCounter con contadores de recursos principales (M38) [S]
...
- [ ] Pausar GameClock durante el diálogo y restaurarlo al cerrar [M]
- [ ] Verificar que el diálogo cierra solo con dialog_finished y restaura el foco [M]
...
- [ ] Navegación completa por foco sin ratón (con gamepad y teclado) [S]
- [ ] Velocidad de texto y pausa de diálogo según M58 [S]
