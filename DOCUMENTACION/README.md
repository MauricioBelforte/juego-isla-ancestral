...
| 154-Vision-Del-Agente | ✅ Creado por Cline — 4 vías de visión para agentes (V1 chat, V2 MCP screen, V3 web+Playwright, V4 godot-mcp ⭐ fundamental), matriz de decisión, protocolo de iteración visual (44/130) |
