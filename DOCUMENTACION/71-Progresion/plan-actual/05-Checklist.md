...
- [x] RF2: tipos de condición evaluables por tipo (stat_min, dias_jugados, nivel_modulo, sello, capitulo, riqueza, coleccion, hito_previo, primera_vez, compuesta) [M]
- [x] RF3: evaluación de condiciones por eventos con dirty flags, nunca por frame [M]
- [x] RF4: UnlockSystem que activa desbloqueos al cumplirse su condición y emite señal [M]
- [x] RF5: señales de progreso estandarizadas: hito, desbloqueo, logro, primera vez, condición imposible [M]
- [x] RF6: perfil de jugador con estadísticas acumuladas alimentado por eventos del EventBus (M07) [M]
- [x] RF7: estadísticas del día con reset al cambiar de día laborable (M29) [M]
- [x] RF8: registro base de logros con condiciones y progreso parcial; presentación en M72 [M]
- [x] RF9: radar de primeras veces (primer recurso, primer pez, primera venta, primera donación) [M]
- [x] RF10: gating suave: condiciones imposibles reportadas a M66 con rutas alternativas [M]
- [x] RF11: reputación comunitaria 0-100 derivada de amistad (M20) y contribuciones (M38), nunca bloqueante [M]
- [x] RF12: títulos sociales cosméticos otorgados por hitos acumulados, sin poder ni bloqueo [M]
- [x] RF13: persistencia de hitos, desbloqueos, estadísticas, primeras veces y reputación en GameState (M59) [M]
- [x] RF14: distinción jugador nuevo (onboarding M92) vs veterano (resumen, sin re-emisión de hitos) [M]
...
- [x] Implementar hitos_alcanzados() devolviendo ids en orden de consecución [S]
- [x] Implementar hitos_proximos(limite) para el sugeridor de metas de M53 (1-3 metas) [M]
- [x] Garantizar idempotencia del marcado de hitos: un hito se alcanza una sola vez [M]
...
- [x] Analizar dominio de colecciones: museo M37, coleccionables M73, fauna M36, fotografía M56 como progresión horizontal [M]
...
- [x] Descartar árbol de habilidades por complejidad y optimización ansiosa [S]
- [x] Descartar progresión lineal estricta por la no linealidad de M22/M23 [S]
- [x] Descartar gating duro por anti-cozy; la historia usa sellos narrativos validados por M22 [M]
- [x] Descartar progresión aislada por módulo por duplicación e imposibilidad de hitos transversales [M]
- [x] Adoptar registry central + eventos (M07) como arquitectura de progresión [M]
- [x] Adoptar rutas alternativas solo para condiciones posiblemente incumplibles (M66) [M]
- [x] Descartar reputación como moneda de bloqueo: solo títulos y ofertas [S]
- [x] Descartar recompensas de poder en logros: solo cosmético/informativo/QoL [S]
- [x] Registrar decisiones D1-D10 en 02-Analisis.md [S]
...
- [x] Diagramar flujo de reflejo de sellos/capítulos de M22 sin validar el grafo [M]
- [x] Diagramar flujo de carga jugador nuevo vs veterano con idempotencia [M]
- [x] Diagramar flujo de condición imposible con cooperación de M66 [M]
- [x] Definir contrato de señales de salida en tabla (emisor/consumidores) [M]
...
- [x] Mantener la regla de recompensas no críticas (cosmético/info/QoL) [S]
...
- [x] Asegurar evaluación perezosa del progreso parcial (solo cuando la UI lo pide) [S]

## M. Integración con M13 (Herramientas)

- [x] Consumir la señal de cambio de nivel de herramienta de M13 (nombre a confirmar) [M]
...
- [x] No intervenir la durabilidad ni la progresión interna de M13 [S]
- [x] Permitir desbloqueos de zonas mecánicas condicionados a niveles de herramienta [M]
- [x] Emitir progreso_desbloqueado si M13 necesita habilitar algo por hito del 71 [S]
...
- [x] No validar construcciones ni mover bloques (M17/M18) [S]
...
- [x] No validar el grafo de la historia: es responsabilidad de M22 [S]
...
- [x] Emitir notificación calmada al reflejar avances narrativos [S]
...
- [x] Garantizar que la riqueza nunca sea requisito de progreso principal (regla de oro) [S]
...
- [x] Condición actualmente no cumplible: reportada a M66 con ruta alternativa [M]
- [x] Condición estáticamente imposible: error bloqueante en editor antes de jugar [M]
...
- [x] Reset de día con estadísticas del día pendientes: resetea solo contadores del día [M]
- [x] Flash de título: aplicar recompensas de título una sola vez, sin duplicados [S]
- [x] Primera vez marcada tras restauración de guardado: se conserva sin duplicar ni perder [M]
- [x] Migración de guardado antiguo sin sección "progresion": inicialización completa con aviso [M]
...
- [x] Reevaluación solo por evento (dirty flags), cero bucles por frame [M]
- [x] Caché de evaluaciones con invalidación selectiva por estadística [M]
- [x] Progreso parcial evaluado de forma perezosa, solo bajo demanda de la UI [M]
...
- [x] Estado de progresión plano (Dictionary) de tamaño acotado, independiente de los frames [S]
- [x] Sin asignaciones pesadas en el camino de evaluación (predicados puros) [M]

## T. Documentación entregada

- [x] Crear 01-Requerimientos.md con problema, objetivo, alcance y RF1-RF16 [M]
- [x] Crear 02-Analisis.md con dominio, curvas, anti-frustración, alternativas y decisiones [M]
- [x] Crear 03-Diseno.md con arquitectura, flujos, clases, contratos de señales y persistencia [M]
