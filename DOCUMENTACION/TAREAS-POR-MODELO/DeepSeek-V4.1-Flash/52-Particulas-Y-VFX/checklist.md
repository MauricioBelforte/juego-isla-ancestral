...
- [ ] T-005 Separar dentro/fuera de alcance: luz de fuego → M49, sonido → M43/M44, sprites → M45/M47 [S]
...
- [ ] T-008 Listar los 25 efectos del plan maestro [M]
- [ ] T-009 Humo y polvo [S]
- [ ] T-010 Hojas y pétalos [S]
- [ ] T-011 Chispas [S]
- [ ] T-012 Agua (salpicaduras) [S]
- [ ] T-013 Lluvia y nieve [S]
- [ ] T-014 Fuego y lava [S]
- [ ] T-015 Luz y magia tecnológica [S]
- [?] T-016 Resonancia y activación de runas [S] — auditoría iter. 5 (Log 882): sin entrada en el catálogo real (8/25)
- [ ] T-017 Teletransporte (si existe) [S]
- [?] T-018 Obtención de Sello [S] — auditoría iter. 5 (Log 882): sin entrada en el catálogo real (8/25)
- [?] T-019 Resolución de puzzle [S] — auditoría iter. 5 (Log 882): sin entrada en el catálogo real (8/25)
- [?] T-020 Construcción, cosecha y pesca [S] — auditoría iter. 5 (Log 882): sin entrada en el catálogo real (8/25)
- [ ] T-021 Descubrimiento [S]
- [?] T-022 Cambio estacional [S] — auditoría iter. 5 (Log 882): sin entrada en el catálogo real (8/25)
- [ ] T-023 Efectos de interfaz [S]
- [ ] T-024 Efectos atmosféricos [S]
- [ ] T-025 Definir parámetros por efecto (tipo, material, emisor, presupuesto) [M]
...
- [ ] T-028 Definir loops registrados con culling [M]
...
- [ ] T-035 Definir loops con fase fija [M]
...
- [ ] T-043 Definir descubrimiento (M71) [M]
- [ ] T-044 Definir festivales (M74) [M]
- [ ] T-045 Definir humo + ascuas de fuego [M]
- [ ] T-046 Definir burbujas + ascuas de lava [M]
- [ ] T-047 Definir sin luz por partícula (luz = M49) [M]
- [ ] T-048 Definir salpicaduras al nadar (M51/M11) [M]
- [ ] T-049 Definir gotas de cascada [M]
- [ ] T-050 Definir chapoteo de balde (M13) [M]
- [ ] T-051 Definir lluvia por clima (M32) [M]
- [x] T-052 Definir nieve por clima/estación (M32/M29) [M]
- [ ] T-053 Definir polvo del desierto [M]
- [ ] T-054 Definir hojas al viento (M50) [M]
- [ ] T-055 Definir pétalos primaverales (M29) [M]
- [ ] T-056 Definir un emisor global por zona (no por chunk) [M]
- [x] T-057 Definir resonancia de runas (M24/M26) [M]
- [x] T-058 Definir activación de glifos [M]
- [ ] T-059 Definir estelas de luz (M47) [M]
- [ ] T-060 Definir magia tecnológica (M86) [S]
- [ ] T-061 Definir partículas 2D en menús/recompensas (M53) [M]
- [ ] T-062 Definir Reduce Motion (M58) [M]
- [ ] T-063 Definir sin estroboscopios (>10 Hz prohibido) [M]
- [x] T-064 Definir transición de VFX por estación (M29) [M]
- [ ] T-065 Definir pétalos ↔ hojas ↔ nieve [M]
...
- [ ] T-069 Definir LOD de emisores (25% lejos) [M]
...
- [ ] T-073 Verificar naming [S]
- [x] T-074 Verificar determinismo (semillas) [M] — iter. 5 (Log 882): implementado y verificado headless
- [ ] T-075 Verificar sin luz por partícula [M]
- [ ] T-076 Verificar mapeo completo de eventos de juego [M]
- [x] T-077 Definir prefijos vfx_, part_ [S]
- [ ] T-078 Alinear con M108 [M]
- [?] T-079 Rendimiento: límites + LOD + pooling (M61) [M] — iter. 5 (Log 882): límites y pooling SÍ; LOD por distancia NO
- [x] T-080 Memoria: pool precalentado (M62) [M] — iter. 5 (Log 882): implementado y verificado headless
- [?] T-081 Determinismo: semillas + fases fijas [M] — iter. 5 (Log 882): semillas SÍ; fases fijas de loops NO (no hay loops)
- [ ] T-082 Cozy: amplitudes suaves, sin humo denso negro [M]
- [x] T-083 Accesible: vfx_quality 3 niveles (M58) [M]
- [ ] T-084 Mantenible: catálogo central único [M]
...
- [ ] T-087 Descartar luz integrada en partículas [M]
...
- [ ] T-091 Riesgo de overdraw → presupuesto + tope + LOD [M]
- [ ] T-092 Riesgo de desincronía → trigger centralizado [M]
...
- [ ] T-108 Documentar flujo de loop ambiental (humo) [M]
- [x] T-109 Documentar flujo de atmosféricos por clima/estación [M]
- [ ] T-110 Todos los efectos del plan maestro en el catálogo [M]
...
- [ ] T-114 Fuego/lava sin luz (solo M49) [M]
