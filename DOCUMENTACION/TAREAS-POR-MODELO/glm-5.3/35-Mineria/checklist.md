...
> Extraídas del `05-Checklist.md` del módulo (82 pendientes de 142 ítems). Fuente de verdad del ítem: el `05-Checklist.md`.
...
- [ ] T-080 Test: veta a medias sobrevive a guardado/carga [M] *(M15 cubre por nodo; M35 cubre zone_quota — pendiente prueba end-to-end con GameTime real)* *[?]*
- [ ] T-081 Profiler en cueva con 50 vetas activas [C] *(pendiente M61 benchmarks; no bloquea iter 1)* *[?]*
- [ ] T-082 Recorrido cozy completo: cantera, cueva norte y Templo sin fallos [C] *(pendiente M138/M26)* *[?]*
