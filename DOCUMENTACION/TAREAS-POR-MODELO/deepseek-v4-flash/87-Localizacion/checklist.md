...
- [x] T-036 Agrupar y documentar las claves por módulo del juego [S]
- [x] T-037 Verificar compatibilidad de caracteres de es/en con las fuentes de M88 [M]
- [x] T-038 Respetar los ajustes de accesibilidad de texto de M58 sin romper layouts [M]
- [x] T-039 Tolerar textos +30% más largos en inglés dentro de los layouts [C]
- [x] T-040 Mantener consistencia de términos con un glosario de traducción [M]
- [x] T-041 Garantizar revisión humana de las traducciones antes del lanzamiento [C]
- [x] T-042 Mantener los .po en UTF-8 sin BOM y saltos LF [S]
- [x] T-043 Prohibir texto visible hardcodeado fuera de los catálogos [M]
- [x] T-044 Garantizar compatibilidad de los .po con Poedit y herramientas gettext [S]
