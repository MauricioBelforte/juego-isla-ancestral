...
- [x] Diseñar logo principal del juego
- [x] Crear variante mono (B/N) del logo
...
- [x] Test de impresión en merchandise
- [x] Aprobar logo final con equipo
- [x] Distribuir logo a partners y prensa
...
- [x] Verificar que fuentes son incluidas en builds
...
- [x] Validar que builds incluyen fuentes correctas
- [x] Test de impresión de logo en merchandise
- [x] Auditoría visual pre-lanzamiento
- [x] Documentar hallazgos y correcciones
...
- [x] Verificar que M97 (Steam Store Page) usa identidad de marca correcta
- [x] Verificar que M98 (Trailer) usa logo y colores de marca
- [x] Verificar que M99 (Marketing) sigue manual de marca
- [x] Verificar que M53 (UI/UX) usa paleta y tipografía de marca
- [x] Verificar que M131 (Créditos) usa formato de marca
