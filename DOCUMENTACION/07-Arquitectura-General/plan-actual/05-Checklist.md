...
- [x] Definir la regla de capas unidireccionales (UI→Servicios→Sistemas→Datos) [S]
- [x] Minimizar dependencias circulares (4 reglas verificables) [S]
- [x] Definir los managers necesarios (lista de 18 servicios) [S]
- [x] Prohibir el GameManager monolítico (Bootstrap orquesta) [S]
- [x] Diseñar el sistema de eventos global tipado (EventBus) [S]
- [x] Diseñar el sistema de configuración (Settings autoload) [S]
...
- [x] Diseñar Bootstrap (autoload 0: registro + arranque) [M]
- [x] Definir el orden de registro de servicios [S]
...
- [x] Registrar el criterio de salida del módulo (bootstrap mínimo en M1) [S]
...
- [x] Documentar el edge case: servicios que arrancan en distinto orden (bootstrap idempotente) [S]
