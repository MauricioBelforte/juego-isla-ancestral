...
- [x] Definir convención para señales: PascalCase → **CORREGIDO**: señales = snake_case (GUIA-GODOT/01-gdscript-errores-comunes.md §1.1 es la autoridad; el PascalCase del checklist original era un error del doc) — nota en la tabla
