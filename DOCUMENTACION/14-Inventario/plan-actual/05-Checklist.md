...
>
> Regresión `test_inventario.gd` re-ejecutada: **0 fallos**. Patrón correcto documentado en GUIA-GODOT/09-godot4-migracion.md §9.64. El checklist de este módulo no cambia (los fixes no alteran RFs ni ítems).
