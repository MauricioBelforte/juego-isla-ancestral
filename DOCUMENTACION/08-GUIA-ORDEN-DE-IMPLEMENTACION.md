...
**Fecha:** 2026-09-02
**Estado:** M117/M119/M122 liberados 🟡 con dudas; M108 disponible; M16 cierre parcial Log 513
...
| M75 Postgame (iter. 1) | 🔵 En curso 2026-09-02 | glm-5.3-flash (Kilo Code) | F7 (producción de contenido) | V0 | M22 ✔ (sellos) | PostgameManager autoload: detección fin de historia vía M22 (7 sellos), estado M59, actividades postgame data-driven sin FOMO (M94), señal postgame_activado para M92/M53 + test headless. Complejidad 3. | game/isla-ancestral/scripts/postgame/{postgame_manager,test_postgame}.gd, data/postgame/actividades.json |
...
| M119 Actualizaciones | 🟡 Con dudas 2026-09-02 | step-3.7-flash (Kilo Code) | F8 (calidad) | V0 | UpdateManager + versions.json 3 canales + test 15/0 Log 517 | Steam/GOG/HTTP, descarga/instalación real y rollback completo delegados a M96/M118/M59/M107/M116. Entrada: núcleo cerrado. Salida: canales y semver operativos para M142/M143. | `scripts/updates/`, `data/updates/` |
...
| M108 Pipeline-De-Assets | 🟢 Disponible 2026-09-02 | step-3.7-flash (Kilo Code) | F8 (calidad) | V0 | Documentación completa; sin scripts implementados | Reserva liberada Log 519 por ausencia de núcleo. Entrada: documentación lista. Salida: validador + presets + promote_asset operativos para M45/M46/M47/M48/M49/M50/M51/M52. | `tools/asset_pipeline/`, `assets/` |
