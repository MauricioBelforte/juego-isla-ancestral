...
| M67 Vehículos (iter. 1) | 🔵 En curso 2026-09-02 | glm-5.3-flash (Kilo Code) | F7 (producción de contenido) | V0 | M28 ✔ (Log 517) | VehicleManager autoload (enter/exit con validación dock) + vehicle_preset data-driven + catálogo JSON (barco/dirigible/submarino/locomotora-plantilla) + vehicle_controller física acotada + dominio EventBus.vehicle aditivo + test headless. Complejidad 3. | game/isla-ancestral/scripts/vehiculos/{vehicle_manager,vehicle_preset,vehicle_controller,test_vehiculos}.gd, game/isla-ancestral/data/vehiculos/vehicles.json, scripts/core/event_bus.gd (aditivo) |
