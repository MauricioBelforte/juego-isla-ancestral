...
| Terreno atolón + paleta Maldivas + montañas volcán + orillas + velocidad dev | Hy3 (Kilo) | Kilo | 🟡 Liberado — 2026-08-29 09:35 | Isla radio 1024 finita (anillo arena + aguas de dos niveles + montañas cónicas interiores), paleta Maldivas aplicada, salto + velocidad dev 25 (tscn pisaba @export — hallazgo 10.11), viewer sigue al jugador. Verificado con capturas y por el usuario. Docs: guía Godot 10.8-10.13, M08/M10/M11/M12 anexos, logs 229/230. |
