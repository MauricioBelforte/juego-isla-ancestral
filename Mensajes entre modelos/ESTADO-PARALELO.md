...
| 154 — Visión del Agente | Cline (Nemotron 3.5 Lightning) | 2026-08-22 | ✅ Documentado (44/130): 4 vías de visión documentadas como alternativas (chat, MCP screen, web+Playwright, godot-mcp ⭐ fundamental); implementación MCP pendiente |
| 154 — Visión del Agente (V5 Blender) | Cline (Nemotron 3.5 Lightning) | 2026-08-22 | ✅ Vía V5 (Blender + blender-mcp) documentada al detalle en plan-actual: guía de instalación, tools, 12 capacidades, snippets bpy, protocolo de iteración; checklist 152 ítems (55 completados) |
