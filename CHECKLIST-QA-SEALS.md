...
> **Auditoria BUG-034 ampliada (2026-09-18, hy3, Log 1012):** cruzados los 86 sellos "Verificado por Hy3" actuales de GLOBAL contra los 30 sellos limpios de este archivo. **Solo 16** coinciden con SEALS; **70 (81%)** citan módulos SIN sello limpio aquí. **42** sellos GLOBAL usan como "prueba" los logs de CIERRE de AGNES **866/867** (no son de hy3). -> **BUG-050 (propuesto):** el regenerador de GLOBAL auto-sella "Verificado por Hy3" en cierres ajenos. No usar la columna GLOBAL como evidencia §21.8; fuente de verdad = este archivo.
